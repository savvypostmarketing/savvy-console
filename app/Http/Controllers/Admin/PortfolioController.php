...
class PortfolioController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'project_overview_es' => ['nullable', 'string'],
            ...
            'video_intro_text' => ['nullable', 'string'],
            'video_intro_text_es' => ['nullable', 'string'],
    ...
    private function formatPortfolio(Portfolio $portfolio): array
    {
        return [
            ...
            'is_published' => $portfolio->is_published,
            'is_featured' => $portfolio->is_featured,
            'published_at' => $portfolio->published_at?->format('Y-m-d H:i:s'),
